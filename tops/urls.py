...
urlpatterns = [
    path('<uuid:meeting_pk>/tops/', views.tops, name="edittops"),
    ...
    path('<uuid:meeting_pk>/addtop/', views.add, name="addtop"),
    path('<uuid:meeting_pk>/edittop/<uuid:top_pk>/', views.edit, name="edittop"),
    path('<uuid:meeting_pk>/deltop/<uuid:top_pk>/', views.delete, name="deltop"),
    path('<uuid:meeting_pk>/topattachment/<uuid:top_pk>/', views.show_attachment, name="showattachment"),
