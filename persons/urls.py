...
urlpatterns = [
    ...
    path('<uuid:meeting_pk>/editatt/<int:attendee_pk>/',views.edit_attendee, name="editattendee"),
    path('<uuid:meeting_pk>/delatt/<int:attendee_pk>/',views.delete_attendee, name="delattendee"),
