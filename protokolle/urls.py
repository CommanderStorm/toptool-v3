...
urlpatterns = [
    path('<uuid:meeting_pk>/protokoll/<str:filetype>/', views.show_protokoll, name="protokoll"),
    ...
    path('<uuid:meeting_pk>/protokoll/attachments/<int:attachment_pk>/', views.show_attachment, name="showattachment_protokoll"),
    path('<uuid:meeting_pk>/protokoll/attachments/<int:attachment_pk>/edit/', views.edit_attachment, name="editattachment"),
    path('<uuid:meeting_pk>/protokoll/attachments/<int:attachment_pk>/delete/', views.delete_attachment, name="deleteattachment"),
]
